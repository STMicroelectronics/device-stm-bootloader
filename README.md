...
**Source**
* `./source/load_bootloader.sh`: script used to load primary and secondary bootloader source with required patches for STM32MP2
...
* `./source/patch/fsbl/<version>/*`: tf-a patches required (not yet upstreamed)
* `./source/patch/ssbl/<version>/*`: u-boot kernel patches required (not yet upstreamed)
